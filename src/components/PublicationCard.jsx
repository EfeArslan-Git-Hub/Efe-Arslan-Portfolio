        ...
        <SpotlightCard className="flex flex-col justify-between group h-full">
            <div className="p-6 flex flex-col h-full">
                <div>
                    ...
                    <h4 className="text-lg font-bold text-gray-200 mb-1 group-hover:text-brand-400 relative z-10 transition-colors">
                        {pub.title}
                    </h4>
                    <p className="text-sm text-brand-500 mb-3 italic relative z-10">
                        {pub.publisher}
                    </p>
                ...
                <div className="flex justify-between items-end border-t border-gray-800 pt-4 mt-auto relative z-10">
